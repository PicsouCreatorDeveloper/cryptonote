...
const uint64_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = "infinity";
...
const unsigned EMISSION_SPEED_FACTOR                         = 44;
...
const uint64_t DIFFICULTY_TARGET                             = 83,33333333; // milliseconds
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 8640;
